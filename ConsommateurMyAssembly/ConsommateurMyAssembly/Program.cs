...
namespace ConsommateurMyAssembly
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //
            Assembly asm = Assembly.LoadFrom(@"C:\Users\amine\Desktop\Lab\MyAssembly.dll");
            Type t = asm.GetType("MyAssembly.MyClass");
            Console.WriteLine("Le type t est = " + t);
            ...
            parameters[0] = 200; // 'count' parameter
            parameters[1] = "Amine."; // 'text' parameter
